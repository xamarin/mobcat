    ...
    public class BiometricAuthenticationService : IBiometricAuthenticationService
    {
        ...
        public BiometricType AvailableBiometricType
        {
            get
            {
                ...
                {
                    Logger.Debug("This device does not have a fingerprint scanner.");
                ...
                {
                    Logger.Debug("Secure lock screen hasn\'t been set up. Goto Settings -> Security to set up a keyguard.");
                    _biometricType = BiometricType.None;
                    _hasEvaluatedBiometricType = true;
                    return _biometricType;
                }
                ...
                {
                    Logger.Debug("Register a fingerprint at Settings -> Security -> Fingerprint.");
                    _biometricType = BiometricType.None;
                    _hasEvaluatedBiometricType = true;
                    return _biometricType;
                }

                Logger.Debug("Device is ready for Fingerprint Scanning");
