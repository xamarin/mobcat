...
////
    ...
    FlutterMethodChannel* fountainChannel = [FlutterMethodChannel
    ...
    [fountainChannel setMethodCallHandler:^(FlutterMethodCall* call, FlutterResult result) {
        ...
        if ([@"ConvertToHtml" isEqualToString:call.method]) {
            NSString* html = [weakSelf convertToHtml];
...
- (NSString*)convertToHtml {
    ...
    NSString *html= [FountainLib_iOS_FountainSharpWrapper convertToHtmlFountainText: data];
