...
echo ""
echo "========== NewsSample Environment Configuration started =========="
echo ""
...
echo "- NewserviceApiKey"
launchctl setenv NewsServiceApiKey $API_KEY

echo "- NewsServiceUrl"
launchctl setenv NewsServiceUrl $SERVICE_ENDPOINT
...
echo ""
echo "========= NewsSample Environment Configuration completed ========="
echo ""